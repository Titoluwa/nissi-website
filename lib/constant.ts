...
export const SERVICES = [
    ...
    //     icon: GiLifeSupport, 
    //     title: "Residential Services & Support",
    //     description: "Comprehensive assistance with housing and independent living needs.",
    //     details: [
    //         "Housing search and application assistance",
    //         "Home safety assessment and modifications",
    //         "Household management support",
    //         "Budgeting and bill payment assistance",
    //         "Landlord communication and advocacy",
